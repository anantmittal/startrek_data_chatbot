...
FILENAME = 'StarTrekHalfLines_nospace.txt'
...
'''
 filter too long and too short sequences by count of words
...
def zero_pad_line(qtokenized, w2idx):

    # numpy arrays to store indices
    idx_q = np.zeros([1,limit['maxq']], dtype=np.int32)
